This repository contains basic python fundamental. For example assigning variable to a string, int and Boolean. Casting already assigned variable to another data type.
